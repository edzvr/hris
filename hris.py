...
<style id="hris-global-sidebar-style">
    body.hris-sidebar-page {{ padding-left: 0 !important; padding-top: 124px !important; }}
    #hris-global-sidebar {{ position: fixed; z-index: 10000; inset: 0 0 auto 0; width: 100vw; height: auto; box-sizing: border-box; display: grid; grid-auto-flow: column; grid-template-rows: repeat(2, 48px); grid-auto-columns: max-content; align-items: stretch; gap: 8px 10px; padding: 10px 14px 12px; background: #122c3b; color: #f4f7f6; box-shadow: 0 3px 14px rgba(7,25,36,.28); font-family: Arial, sans-serif; overflow-x: auto; overflow-y: hidden; -webkit-overflow-scrolling: touch; overscroll-behavior-x: contain; touch-action: pan-x; }}
    #hris-global-sidebar h2 {{ grid-row: 1 / span 2; align-self: center; margin: 0 10px 0 0; font-size: 24px; line-height: 28px; letter-spacing: .2px; white-space: nowrap; }}
    #hris-global-sidebar p {{ display: none; }}
    #hris-global-sidebar a {{ display: flex !important; align-items: center; justify-content: center; box-sizing: border-box; width: auto !important; height: 48px !important; min-height: 48px !important; min-width: max-content; padding: 12px 18px !important; margin: 0 !important; color: #f4f7f6; text-decoration: none; border-left: 0; border-bottom: 3px solid transparent; border-radius: 7px; font-size: 17px !important; line-height: 22px !important; white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis; }}
