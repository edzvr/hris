...
<style id="hris-global-sidebar-style">
    ...
    @media (max-width: 760px) {{ body.hris-sidebar-page {{ padding-left: 208px !important; padding-top: 0 !important; }} #hris-global-sidebar {{ position: fixed !important; inset: 0 auto 0 0 !important; width: 190px !important; height: 100vh !important; max-height: 100vh !important; box-sizing: border-box; padding: 18px 10px; overflow-x: hidden !important; overflow-y: scroll !important; -webkit-overflow-scrolling: touch; overscroll-behavior: contain; touch-action: pan-y; }} #hris-global-sidebar h2, #hris-global-sidebar p {{ display: block; }} #hris-global-sidebar a {{ white-space: normal; margin: 4px 0; padding: 10px 9px; border-left: 3px solid transparent; border-bottom: 0; }} #hris-global-sidebar a:hover, #hris-global-sidebar a:focus-visible {{ border-left-color: #e5b85c; border-bottom-color: transparent; }} #hris-global-sidebar .sidebar-logout {{ margin-top: 24px; border-top: 1px solid #426157; padding-top: 16px; }} }}
</style>
