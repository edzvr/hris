...
<style id="hris-global-sidebar-style">
    ...
    @media (max-width: 760px), (max-device-width: 920px) {{ body.hris-sidebar-page {{ padding-left: 0 !important; padding-top: 82px !important; }} #hris-global-sidebar {{ inset: 0 0 auto 0 !important; width: 100vw !important; height: auto !important; max-height: none !important; box-sizing: border-box; display: flex; align-items: center; gap: 7px; padding: 8px 10px 9px; overflow-x: auto !important; overflow-y: hidden !important; -webkit-overflow-scrolling: touch; overscroll-behavior-x: contain; touch-action: pan-x; }} #hris-global-sidebar h2 {{ flex: 0 0 auto; margin: 0 3px 0 0; font-size: calc(18px * var(--sidebar-scale)); line-height: 22px; }} #hris-global-sidebar p {{ display: none; }} #hris-sidebar-controls {{ flex: 0 0 108px; margin: 0 4px 0 0; }} #hris-sidebar-controls button {{ height: 36px; font-size: 14px; }} #hris-global-sidebar a {{ flex: 0 0 auto; width: auto !important; height: calc(42px * var(--sidebar-scale)) !important; min-height: calc(42px * var(--sidebar-scale)) !important; min-width: max-content; padding: 10px 13px !important; margin: 0 !important; border-left: 0; border-bottom: 3px solid transparent; border-radius: 7px; font-size: max(15px, calc(15px * var(--sidebar-scale))) !important; line-height: 20px !important; }} #hris-global-sidebar a:hover, #hris-global-sidebar a:focus-visible, #hris-global-sidebar a[href="{request.path}"] {{ border-left-color: transparent; border-bottom-color: #f2c14e; }} #hris-global-sidebar .sidebar-logout {{ margin-top: 0 !important; border-top: 0; padding-top: 10px !important; }} }}
</style>
<aside id="hris-global-sidebar">
    <h2>HRIS</h2>
    <p>{'Admin workspace' if is_admin else 'Employee self-service'}</p>
    <div id="hris-sidebar-controls" aria-label="Sidebar text size controls"><button type="button" data-sidebar-zoom="down" title="Smaller text">A−</button><button type="button" data-sidebar-zoom="reset" title="Reset text size">A</button><button type="button" data-sidebar-zoom="up" title="Larger text">A+</button></div>
    {link_markup}
